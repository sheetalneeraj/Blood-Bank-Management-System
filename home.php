...
<div class="x">
	...
	<div style="font-size: 30px;padding-top: 20px;font-weight: bold;padding-left: 10px"><a href="home.php">BLOOD DONATION MANAGEMENT SYSTEM</a></div>
</div>
...
<div class="p">
	...
	<div class="v" style="font-size: 60px;margin-top: 520px;margin-right: 10px">|</div>
		<a href="About_us.php" style="text-align: center;font-size: 50px;float: right;margin-top: 520px;margin-right: 20px;">About Us</a>
</div>
</body>
</html>
